      ...
      <section class="hero">
        ...
        <div class="hero-track-anim" aria-hidden="true">
          <svg viewBox="0 0 520 230" focusable="false">
            <path
              class="hero-track-bg"
              d="M249,204 L72,204 C63,204 57,201 52,194 C44,182 48,165 60,155 C70,148 78,145 84,139 C91,132 87,124 94,118 C101,111 112,110 120,106 C130,101 140,93 150,92 C160,91 170,99 178,108 C186,116 192,127 202,133 C213,140 226,144 238,138 C250,132 258,120 262,104 C266,88 268,70 272,54 C276,38 284,28 296,26 C308,24 318,32 324,48 C330,64 332,82 336,98 C340,114 344,128 352,136 C360,144 372,144 384,138 C396,132 404,122 414,112 C424,102 436,94 450,92 C464,90 478,96 486,106 C494,116 496,130 494,144 C492,158 488,172 480,184 C470,198 452,204 428,204 Z"
              fill="none"
              stroke="currentColor"
              stroke-opacity="0.25"
              stroke-width="3"
