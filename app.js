      ...
      <section class="hero">
        ...
        <div class="hero-track-anim" aria-hidden="true">
          <svg viewBox="0 0 520 230" focusable="false">
            <path
              class="hero-track-bg"
              d="M249,204 L72,204 C63,204 57,201 52,194 C44,182 48,165 60,155 C70,147 84,141 98,132 C110,124 122,114 134,108 C144,102 154,99 162,101 C170,103 175,104 182,109 C189,113 195,112 201,116 C208,121 214,129 219,138 C226,146 232,150 238,144 C244,138 248,126 251,110 C254,94 256,72 259,52 C262,36 267,27 275,24 C283,21 289,26 292,38 C295,50 296,70 299,90 C302,110 306,128 314,140 C322,150 334,153 346,152 C358,151 366,146 374,139 C382,132 386,127 392,124 C398,121 404,120 410,116 C418,110 426,102 435,97 C444,92 454,90 462,92 C472,94 480,98 487,106 C495,115 499,129 497,144 C495,160 489,177 477,189 C465,199 448,204 428,204 Z"
              fill="none"
              stroke="currentColor"
              stroke-opacity="0.25"
              stroke-width="3"
            ...
            <path
              ...
              d="M100,203 C108,195 118,191 132,191 L362,191 C376,191 386,195 394,203"
              fill="none"
              stroke="currentColor"
              stroke-opacity="0.5"
              stroke-width="2"
