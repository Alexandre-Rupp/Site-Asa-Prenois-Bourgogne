      ...
      <section class="hero">
        ...
        <div class="hero-track-anim" aria-hidden="true">
          <svg viewBox="0 0 520 226" focusable="false">
            <path
              class="hero-track-bg"
              d="M251.8,208.5 C186.3,208.5 92.0,208.5 55.4,208.5 C18.9,207.3 38.6,205.9 32.7,201.3 C26.8,196.7 21.4,188.4 20.0,181.1 C18.6,173.9 20.8,164.8 24.6,157.7 C28.3,150.5 30.5,143.2 42.4,138.3 C54.4,133.4 79.6,134.0 96.4,128.4 C113.1,122.8 129.8,107.8 143.1,104.6 C156.3,101.5 163.4,103.3 175.7,109.2 C188.1,115.1 207.5,135.3 217.4,140.1 C227.2,144.9 230.1,141.4 234.8,138.0 C239.5,134.5 242.5,136.5 245.7,119.4 C248.9,102.4 249.7,52.6 253.8,35.7 C257.9,18.8 265.8,20.6 270.5,18.0 C275.2,15.4 278.5,18.0 281.8,20.0 C285.1,21.9 285.5,12.6 290.2,29.9 C295.0,47.2 305.1,105.6 310.6,123.8 C316.1,141.9 318.9,136.0 323.5,138.6 C328.1,141.3 332.5,141.2 338.2,139.8 C343.9,138.3 347.9,139.0 357.5,130.0 C367.0,121.0 386.1,94.5 395.4,85.6 C404.8,76.7 406.4,77.3 413.5,76.5 C420.5,75.6 426.6,74.8 437.7,80.5 C448.7,86.2 472.8,105.4 480.0,110.5 C487.2,115.6 477.4,106.6 480.7,111.1 C484.0,115.7 496.7,128.1 499.9,138.0 C503.1,147.8 503.1,160.6 500.0,170.3 C496.9,180.0 489.7,189.7 481.0,196.1 C472.4,202.5 486.3,206.5 448.1,208.5 C409.9,208.5 317.2,208.5 251.8,208.5 Z"
              fill="none"
              stroke="currentColor"
              stroke-opacity="0.25"
              stroke-width="3"
            ...
            <path
              ...
              d="M94.7,208.5 C100.7,200.5 104.7,200.5 110.7,200.5 L392.8,200.5 C398.8,200.5 402.8,200.5 408.8,208.5"
              fill="none"
              stroke="currentColor"
              stroke-opacity="0.5"
              stroke-width="2"
