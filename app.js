      ...
      <section class="hero">
        ...
        <div class="hero-track-anim" aria-hidden="true">
          <svg viewBox="0 0 520 226" focusable="false">
            <path
              class="hero-track-bg"
              d="M268.6,208.7 C203.1,208.7 110.5,208.7 72.1,208.7 C33.6,206.5 46.4,201.7 37.7,195.3 C29.0,189.0 22.9,179.9 20.0,170.4 C17.1,160.8 16.9,148.0 20.2,138.1 C23.4,128.2 36.1,115.7 39.4,111.2 C42.7,106.6 32.9,115.8 40.1,110.7 C47.2,105.5 71.4,86.2 82.5,80.5 C93.6,74.8 99.6,75.6 106.7,76.5 C113.8,77.3 115.7,76.7 124.9,85.6 C134.1,94.5 152.3,120.7 161.9,129.8 C171.5,138.9 176.7,138.9 182.6,140.4 C188.5,141.9 192.9,141.3 197.3,138.9 C201.7,136.6 203.6,144.4 209.0,126.2 C214.3,108.1 224.6,47.9 229.5,30.1 C234.3,12.4 234.5,21.7 238.0,19.7 C241.5,17.6 246.7,17.4 250.3,18.0 C254.0,18.6 257.2,20.5 259.8,23.4 C262.4,26.2 263.8,19.2 266.1,35.2 C268.5,51.2 270.9,102.4 274.1,119.6 C277.2,136.9 280.3,135.2 285.0,138.7 C289.8,142.2 292.7,145.7 302.5,140.8 C312.4,135.9 331.8,115.3 344.2,109.3 C356.5,103.3 363.6,101.5 376.8,104.7 C390.0,108.0 406.8,123.3 423.4,128.8 C440.1,134.4 464.7,133.1 476.6,137.8 C488.5,142.5 491.1,149.9 495.0,157.1 C498.9,164.4 501.5,173.8 500.0,181.4 C498.5,188.9 492.1,197.9 486.3,202.4 C480.5,207.0 501.4,207.7 465.1,208.7 C428.8,208.7 334.1,208.7 268.6,208.7 Z"
              fill="none"
              stroke="currentColor"
              stroke-opacity="0.25"
              stroke-width="3"
            ...
            <path
              ...
              d="M111.4,208.7 C117.4,200.7 121.4,200.7 127.4,200.7 L409.8,200.7 C415.8,200.7 419.8,200.7 425.8,208.7"
              fill="none"
              stroke="currentColor"
              stroke-opacity="0.5"
              stroke-width="2"
