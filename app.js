      ...
      <section class="hero">
        ...
        <div class="hero-track-anim" aria-hidden="true">
          <svg viewBox="0 0 520 230" focusable="false">
            <path
              class="hero-track-bg"
              d="M249,204 L72,204 C63,204 57,201 52,194 C44,182 48,165 60,155 C70,147 84,141 98,132 C110,124 122,114 134,108 C146,101 158,100 166,104 C173,107 178,106 186,112 C196,120 204,130 214,137 C224,143 232,142 238,138 C250,132 258,120 262,104 C266,88 268,70 272,54 C276,38 284,28 296,26 C308,24 318,32 324,48 C330,64 332,82 336,98 C340,114 344,128 352,136 C360,144 370,143 380,139 C390,135 394,128 398,124 C402,120 408,119 412,116 C418,111 424,104 432,98 C442,93 452,91 462,93 C472,95 480,99 486,106 C494,116 496,130 494,144 C492,158 488,172 480,184 C470,198 452,204 428,204 Z"
              fill="none"
              stroke="currentColor"
              stroke-opacity="0.25"
              stroke-width="3"
