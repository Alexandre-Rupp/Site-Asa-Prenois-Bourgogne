    ...
    <div class="view-stack">
      <section class="hero">
        ...
        <div class="hero-track-anim" aria-hidden="true">
          <svg viewBox="0 0 520 226" focusable="false">
            <path
              class="hero-track-bg"
              d="M251.42,208.66 C185.91,208.66 87.57,208.66 54.88,208.66 C43.67,206.94 38.63,206.18 32.84,201.71 C26.93,197.15 21.37,188.64 20.00,181.32 C18.64,174.03 21.01,164.92 24.56,157.89 C28.31,150.46 36.47,142.46 42.63,138.24 C47.28,135.04 50.77,134.10 56.82,132.64 C66.60,130.29 83.14,132.71 96.52,128.76 C111.87,124.24 128.63,107.19 143.17,104.72 C154.69,102.76 164.87,104.74 175.82,109.28 C189.59,114.99 205.99,137.62 217.43,140.70 C224.09,142.49 230.31,141.63 234.94,138.57 C240.10,135.16 243.02,128.61 245.90,119.59 C251.56,101.86 249.31,50.21 253.88,35.14 C255.70,29.16 257.40,26.29 260.24,23.39 C262.80,20.77 266.20,18.67 269.68,18.00 C273.40,17.28 278.54,17.79 281.97,19.71 C285.53,21.70 287.73,24.36 290.48,30.06 C297.89,45.45 302.34,108.63 310.84,125.44 C314.47,132.64 317.98,136.39 322.68,138.80 C326.96,141.00 332.27,141.28 337.41,140.33 C343.73,139.17 351.20,134.55 357.41,130.24 C363.89,125.74 369.56,120.25 375.35,113.63 C382.21,105.79 387.81,91.86 395.13,85.56 C400.77,80.71 406.66,77.46 413.34,76.45 C420.66,75.35 428.77,76.88 437.49,80.48 C450.21,85.73 476.80,108.24 479.94,110.63 C480.35,110.93 480.27,110.81 480.61,111.17 C482.69,113.37 496.64,128.12 499.85,138.06 C503.03,147.87 503.10,160.67 500.00,170.35 C496.94,179.90 489.84,189.50 481.61,195.82 C472.80,202.59 464.23,205.66 447.97,208.66 C409.98,208.66 316.94,208.66 251.42,208.66 Z"
              fill="none"
              stroke="currentColor"
              stroke-opacity="0.25"
              stroke-width="3"
            ...
            />
            <path
              class="hero-track-pitlane"
              d="M94.2,208.7 C100.2,200.7 104.2,200.7 110.2,200.7 L392.7,200.7 C398.7,200.7 402.7,200.7 408.7,208.7"
              fill="none"
              stroke="currentColor"
              stroke-opacity="0.5"
              stroke-width="2"
            ...
            <rect class="hero-track-car" x="-10" y="-5" width="20" height="10" rx="5" fill="#fff">
